...
<body class="profile-page sidebar-collapse">
    ...
    <nav class="navbar navbar-expand-lg bg-primary fixed-top navbar-transparent " color-on-scroll="400">
        <div class="container">
            <div class="navbar-translate">
                <a href="admin_index.php" class="navbar-brand" rel="tooltip" title="Designed and Coded by Vishal and Bharti." data-placement="bottom" target="">
                    E-Commerce
                </a>
    ...
    <!-- End Navbar -->
        ...
        <div class="wrapper">
            ...
            <div class="page-header-image" data-parallax="true" style="background-image: url('../assets/img/alien.jpg');"></div>
                <div class="container">
